...
export interface JobOpening {
  ...
  remote_policy?: RemotePolicy | string
  ...
  currency?: string
  compensation_source?: CompensationSource | string
  ...
  scraper_source?: ScraperSource | string
...
export interface CompensationDetail {
  ...
  currency?: string
  display_lpa?: number | null
  display_crores?: number | null
}
...
export interface CareerRecommendation {
  ...
  remote_fit?: string | boolean
  visa_fit?: string | boolean | null
  application_url?: string | null
